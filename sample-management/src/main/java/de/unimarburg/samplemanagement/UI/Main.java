...
public class Main extends HorizontalLayout {
    ...
    @Autowired
    public Main(ClientStateService clientStateService, UserRepository userRepository) {
        ...
        impressumButton.addClickListener(e -> getUI().ifPresent(ui -> ui.navigate("impressum")));

        Button datenschutzerklaerungButton = new Button("Privacy Policy");
        datenschutzerklaerungButton.addClickListener(e -> getUI().ifPresent(ui -> ui.navigate("datenschutzerklaerung")));
